...
const TourDetails = () => {
  ...
  <section>
    <Container>
      {
        loading && <h4 classname = "text-centerpt-5">Loading...</h4> 
      }
      {
        error && <h4 classname = "text-centerpt-5">{error}</h4> 
      }
      {
        !loading && !error &&  <Row>
        <Col lg='8'>
          <div className="tour__content">
            ...
            <div className="tour__reviews mt4">
              <h4>Reviews ({reviews?.length} reviews)</h4>
                <Form onSubmit={submitHandler}>
                  ...
                  <div className="review__input">
                    <input type="text" ref={reviewMessageRef} placeholder="Share your thoughts" />
